    ...
    internal class Setting
    {
        ...
        static Setting()
        {
            AllSettings = new Dictionary<ShortcutTarget, Setting>()
            {
                ...
                { ShortcutTarget.FlowShift, new Setting(Localization.Strings.ShortcutFlowShift, -255, 255) },
                ...
                { ShortcutTarget.JitterFlowLoss, new Setting(Localization.Strings.ShortcutJitterFlowLoss, 0, 255) },
                ...
                { ShortcutTarget.TabPressureFlow, new Setting(string.Format(Localization.Strings.TabPressureSetting, Localization.Strings.TabPressure, Localization.Strings.ShortcutFlow), 0, 255) },
                ...
                { ShortcutTarget.TabPressureJitterFlowLoss, new Setting(string.Format(Localization.Strings.TabPressureSetting, Localization.Strings.TabPressure, Localization.Strings.ShortcutJitterFlowLoss), -255, 255) },
                ...
                { ShortcutTarget.DoLockR, new Setting(Localization.Strings.ShortcutLockR, ShortcutTargetDataType.Bool) },
                { ShortcutTarget.DoLockG, new Setting(Localization.Strings.ShortcutLockG, ShortcutTargetDataType.Bool) },
                { ShortcutTarget.DoLockB, new Setting(Localization.Strings.ShortcutLockB, ShortcutTargetDataType.Bool) },
                { ShortcutTarget.DoLockHue, new Setting(Localization.Strings.ShortcutLockHue, ShortcutTargetDataType.Bool) },
                { ShortcutTarget.DoLockSat, new Setting(Localization.Strings.ShortcutLockSat, ShortcutTargetDataType.Bool) },
                { ShortcutTarget.DoLockVal, new Setting(Localization.Strings.ShortcutLockVal, ShortcutTargetDataType.Bool) },
